...
$consulta = $conexion -> prepare("
	SELECT * FROM especialidades ORDER BY idespecialidad limit 10");

$consulta ->execute();
$consulta = $consulta ->fetchAll();
if(!$consulta){
	$mensaje .= 'NO HAY SERVICIOS PARA MOSTRAR';
}
?>
			...
			<?php include 'plantillas/nav.php'; ?>
				<article>
					<div class="mensaje">
						...
						<a class="agregar" href="agregarEspecialidades.php">Agregar Servicio</a>
						<table class="tabla">
						  <tr>
							<th>#</th>
